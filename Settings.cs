...
namespace SadConsoleEditor
{
    public static class Settings
    {
        ...
        public static Color Color_TextSelectedDark  = Color.Yellow * 0.9f;
        public static Color Color_TextDim = Color.Gray;
        public static Color Color_TextDark = Color.Gray * 0.7f;
        public static Color Color_ControlBack = Color_MenuBack * 0.8f; 
        public static Color Color_ControlBackDim = Color.DarkBlue * 0.3f;
        public static Color Color_ControlBackSelected = Color.Blue;
        ...
        public static void SetupThemes()
        {
            ...
            SadConsole.Themes.Library.Default.RadioButtonTheme.Button.Focused = Appearance_ControlSelected;
            ...
            SadConsole.Themes.Library.Default.RadioButtonTheme.Selected = Appearance_ControlNormal;
            ...
            SadConsole.Themes.Library.Default.WindowTheme.BorderStyle.Background = Color_ControlBack;
