...
namespace SadConsoleEditor.Editors
{
    ...
    //    public ITextSurface Surface { get { return consoleLayers.TextSurface; } }
    ...
    //    public EntityEditor2()
    //    {
    //        loadersSave = new List<FileLoaders.IFileLoader>() { new FileLoaders.GameObject() };
    ...
    //        consoleLayers.TextSurface = new LayeredTextSurface(animation.Width, animation.Height, 2);
    //        consoleLayers.Renderer = new LayeredTextRenderer();
    //        SyncSpecialLayerToAnimation();
    //        ((LayeredTextSurface)consoleLayers.TextSurface).SetActiveLayer(0);
    ...
    //        var meta = ((LayeredTextSurface)consoleLayers.TextSurface).GetLayer(0);
    //        meta.Cells = meta.RenderCells = frame.Cells;
    //        ((LayeredTextSurface)consoleLayers.TextSurface).SetActiveLayer(0);
    //    }
    ...
    //    public void Reset()
    //    {
    //        ControlPanels = new CustomPanel[] { EditorConsoleManager.Instance.ToolPane.FilesPanel, entityNamePanel, animationPanel, framesPanel, EditorConsoleManager.Instance.ToolPane.ToolsPanel };

    //        if (consoleLayers != null)
    //        {
    //            consoleLayers.MouseMove -= _mouseMoveHandler;
    //            consoleLayers.MouseEnter -= _mouseEnterHandler;
    //            consoleLayers.MouseExit -= _mouseExitHandler;
    //        }

    //        consoleLayers = new Console(25, 10);
    //        consoleLayers.TextSurface = new LayeredTextSurface(25, 10, SadConsoleEditor.Settings.Config.ScreenFont, 1);
            
    //        consoleLayers.CanUseMouse = true;
    //        consoleLayers.CanUseKeyboard = true;
    //        LayerMetadata.Create("Root", false, false, true, ((LayeredTextSurface)consoleLayers.TextSurface).ActiveLayer);
            
    //        width = 25;
    //        height = 10;

    //        _mouseMoveHandler = (o, e) => { if (this.MouseMove != null) this.MouseMove(consoleLayers, e); EditorConsoleManager.Instance.ToolPane.SelectedTool.MouseMoveSurface(e.OriginalMouseInfo, consoleLayers.TextSurface); };
    //        _mouseEnterHandler = (o, e) => { if (this.MouseEnter != null) this.MouseEnter(consoleLayers, e); EditorConsoleManager.Instance.ToolPane.SelectedTool.MouseEnterSurface(e.OriginalMouseInfo, consoleLayers.TextSurface); };
    //        _mouseExitHandler = (o, e) => { if (this.MouseExit != null) this.MouseExit(consoleLayers, e); EditorConsoleManager.Instance.ToolPane.SelectedTool.MouseExitSurface(e.OriginalMouseInfo, consoleLayers.TextSurface); };
    ...
    //        EditorConsoleManager.Instance.ToolPane.SelectedTool.ProcessKeyboard(info, consoleLayers.TextSurface);
    //    }

    //    public void ProcessMouse(MouseInfo info)
    //    {
    //        consoleLayers.ProcessMouse(info);

    //        EditorConsoleManager.Instance.ToolPane.SelectedTool.ProcessMouse(info, consoleLayers.TextSurface);

    //        if (consoleLayers.IsMouseOver)
    ...
    //        {
    //            _specialToolRenderer.Render(_specialToolLayer, consoleLayers.Position);
    //        }
    //    }

    //    public void Update()
    //    {
    //        consoleLayers.Update();
    //    }
    ...
    //    {
    //        consoleLayers.Position = new Point(x, y);
    //    }

    //    public void Position(Point newPosition)
    //    {
    //        consoleLayers.Position = newPosition;
    //    }

    //    public Point GetPosition()
    //    {
    //        return consoleLayers.Position;
    //    }
    ...
    //    {
    //        ((LayeredTextSurface)consoleLayers.TextSurface).Remove(index);
    //    }

    //    public void MoveLayerUp(int index)
    //    {
    //        var layer = ((LayeredTextSurface)consoleLayers.TextSurface).GetLayer(index);
    //        ((LayeredTextSurface)consoleLayers.TextSurface).Move(layer, index + 1);
    //    }
    ...
    //    {
    //        LayerMetadata.Create(name, true, true, true, ((LayeredTextSurface)consoleLayers.TextSurface).Add());
    //    }
    ...
    //            {
    //                var newLayer = ((LayeredTextSurface)consoleLayers.TextSurface).Add();
    //                LayerMetadata.Create("Loaded", true, true, true, newLayer);
    //                var tempSurface = new TextSurface(consoleLayers.Width, consoleLayers.Height,
    //                                                  newLayer.Cells,       consoleLayers.TextSurface.Font);
    //                surface.Copy(tempSurface);
    //                newLayer.Cells = tempSurface.Cells;
    //            }
    //            else
    //            {
    //                var layer = ((LayeredTextSurface)consoleLayers.TextSurface).Add();
    ...
    //        ((LayeredTextSurface)consoleLayers.TextSurface).Save(file, typeof(LayerMetadata));
    //    }

    //    public void SetActiveLayer(int index)
    //    {
    //        ((LayeredTextSurface)consoleLayers.TextSurface).SetActiveLayer(index);
    //    }
