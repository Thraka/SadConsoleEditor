...
namespace SadConsoleEditor.Panels
{
    class LineToolPanel : CustomPanel
    {
        ...
        public LineToolPanel()
        {
            ...
            _lineForeColor = new Controls.ColorPresenter("Foreground", SadConsole.Themes.Library.Default.Colors.Green, 18);
            ...
            _lineBackColor = new Controls.ColorPresenter("Background", SadConsole.Themes.Library.Default.Colors.Green, 18);
            ...
            _lineCharPicker = new Controls.ColorPresenter("Glyph", SadConsole.Themes.Library.Default.Colors.Green, 18);
