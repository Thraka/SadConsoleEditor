...
namespace SadConsoleEditor.Panels
{
    public class CharacterPickPanel: CustomPanel
    {
        ...
        public CharacterPickPanel(string title, bool hideCharacter, bool hideForeground, bool hideBackground)
        {
            ...
            _foreColor = new ColorPresenter("Foreground", SadConsole.Themes.Library.Default.Colors.Green, SadConsoleEditor.Consoles.ToolPane.PanelWidthControls);
            _backColor = new ColorPresenter("Background", SadConsole.Themes.Library.Default.Colors.Green, SadConsoleEditor.Consoles.ToolPane.PanelWidthControls);
            _charPreview = new ColorPresenter("Character", SadConsole.Themes.Library.Default.Colors.Green, SadConsoleEditor.Consoles.ToolPane.PanelWidthControls);
        ...
        void Mirror_IsSelectedChanged(object sender, EventArgs e)
        {
            if (_mirrorLR.IsSelected && _mirrorTB.IsSelected)
                _charPreview.Surface[_charPreview.Width - 2, 0].Mirror = Microsoft.Xna.Framework.Graphics.SpriteEffects.FlipVertically | Microsoft.Xna.Framework.Graphics.SpriteEffects.FlipHorizontally;
            else if (_mirrorLR.IsSelected)
                _charPreview.Surface[_charPreview.Width - 2, 0].Mirror = Microsoft.Xna.Framework.Graphics.SpriteEffects.FlipHorizontally;
            else if (_mirrorTB.IsSelected)
                _charPreview.Surface[_charPreview.Width - 2, 0].Mirror = Microsoft.Xna.Framework.Graphics.SpriteEffects.FlipVertically;
            else
