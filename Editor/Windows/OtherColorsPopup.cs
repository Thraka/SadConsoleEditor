...
namespace SadConsoleEditor.Windows
{
    class OtherColorsPopup : SadConsole.Window
    {
            ...
            : base(40, 20)
        {
            ...
            _namedColorsList = new ListBox(Width - 4, Height - 3 - ansiButtonStartY, new SadConsole.Themes.ListBoxItemColorTheme());
        ...
        public override void Invalidate()
        {
            ...
            if (!_namedColorsList.IsVisible)
            {
                ...
                if (_selectedAnsiColorIcon != Point.Zero)
                {
                    ...
                    this[_selectedAnsiColorIcon.X, _selectedAnsiColorIcon.Y].Foreground = Theme.Colors.TitleText;
                }
            }
        ...
        private class AnsiButtonTheme: SadConsole.Themes.ButtonTheme
        {
