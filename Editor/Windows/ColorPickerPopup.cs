...
namespace SadConsoleEditor.Windows
{
    class ColorPickerPopup: SadConsole.Window
    {
        ...
        public ColorPickerPopup(): base(Config.Program.ColorPickerSettings.WindowWidth, Config.Program.ColorPickerSettings.WindowHeight)
        {
            ...
            _previousColors = new ListBox(RideSideX - 4, Height - 20 - 9 + 1, new SadConsole.Themes.ListBoxItemColorTheme());
        ...
        public override void Invalidate()
        {
            ...
            Print(lineX + 2, lineY - 4, "Red", Theme.Colors.Red);
            Print(lineX + 2, lineY - 3, "Green", Theme.Colors.Green);
            Print(lineX + 2, lineY - 2, "Blue", Theme.Colors.Blue);
            Print(lineX + 2, lineY - 1, "Alpha", Theme.Colors.Gray);

            // Preview area
            Print(lineX + 2, 1, "Selected Color");

            DrawBox(new Rectangle(lineX + 2, 2, 14, 3), Theme.WindowTheme.FillStyle, new SadConsole.Cell(Theme.WindowTheme.FillStyle.Foreground, SelectedColor));

            // Current selected gradient colors
            Print(lineX + 2, 5, SelectedColor.R.ToString().PadLeft(3, '0'), Theme.Colors.Red);
            Print(lineX + 2, 6, SelectedColor.G.ToString().PadLeft(3, '0'), Theme.Colors.Green);
            Print(lineX + 13, 5, SelectedColor.B.ToString().PadLeft(3, '0'), Theme.Colors.Blue);
